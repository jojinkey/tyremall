      ...
      <div id="brands" className="py-24 bg-slate-50 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 bg-slate-900 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <a
              href="https://wa.me/917088977333?text=Hi%20Tyremall,%20I%20would%20like%20to%20get%20a%20quote%20for%20tyres."
              target="_blank"
              rel="noreferrer"
    ...
    <div id="about" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center animate-on-scroll is-visible">
          <a href="https://wa.me/917088977333?text=Hi%20Tyremall,%20I%20would%20like%20to%20get%20a%20free%20quote%20for%20tyres." target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 clip-btn bg-brand-red text-white px-10 py-4 font-bold uppercase tracking-widest text-sm hover:bg-slate-900 transition-colors duration-300 shadow-lg shadow-red-500/20 pulse-animation">
