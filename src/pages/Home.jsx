...
const ConversionBanner = ({ isVisible, onClose }) => {
  ...
  const quickServices = [
    { title: 'New Tyres', subtitle: 'Best Brands & Prices', icon: <Car className="w-6 h-6" />, message: "Hi Tyremall, I am looking to buy New Tyres. Please help me with the best options and pricing.", cta: "Get Quote Now" },
    { title: 'Alignment', subtitle: '3D Laser Precision', icon: <Crosshair className="w-6 h-6" />, message: "Hi Tyremall, I would like to book a 3D Wheel Alignment service.", cta: "Book Now" },
    { title: 'Nitrogen', subtitle: 'Optimized Pressure', icon: <Gauge className="w-6 h-6" />, message: "Hi Tyremall, I want to avail the Nitrogen Filling service for my vehicle.", cta: "Avail Now" },
    { title: 'Puncture', subtitle: 'Express Repair', icon: <ShieldCheck className="w-6 h-6" />, message: "Hi Tyremall, I urgently need a Puncture Repair service.", cta: "Urgent Help" },
    { title: 'Balancing', subtitle: 'Vibration-Free Ride', icon: <Settings2 className="w-6 h-6" />, message: "Hi Tyremall, I would like to get my wheels balanced.", cta: "Fix Now" }
  ];

  const getWhatsAppLink = (message) => {
    return `https://wa.me/7088110172?text=${encodeURIComponent(message)}`;
  };

  return (
    <div className="fixed inset-0 z-[9000] flex items-center justify-center p-4 sm:p-6">
      <div
        className="fixed inset-0 bg-slate-950/90 backdrop-blur-xl transition-opacity cursor-pointer"
        onClick={onClose}
      ></div>

      <div className="relative w-full max-w-4xl max-h-[95vh] overflow-y-auto bg-gradient-to-br from-slate-900 via-slate-950 to-black rounded-[40px] border border-slate-700/50 shadow-[0_50px_150px_rgba(0,0,0,0.9),0_0_100px_rgba(238,63,44,0.15)] p-8 md:p-12 animate-futuristic-pop">

        {/* Animated background glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-gradient-to-b from-brand-red/20 via-brand-red/5 to-transparent blur-[100px] rounded-full pointer-events-none animate-pulse"></div>
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-gradient-to-tl from-brand-red/10 to-transparent blur-[80px] rounded-full pointer-events-none"></div>
        ...
        <div className="text-center relative z-10 mb-12">
          ...
          <img
            src="https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/TyreMall%20logo.png"
            alt="Tyremall"
            className="mx-auto h-14 sm:h-18 mb-8 drop-shadow-2xl"
            style={{ filter: 'drop-shadow(0px 0px 30px rgba(238,63,44,0.8))' }}
          />

          {/* Premium Badge */}
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-brand-red/20 via-brand-red/10 to-brand-red/20 border border-brand-red/40 mb-6 shadow-[0_0_30px_rgba(238,63,44,0.3)]">
            <div className="flex items-center gap-1">
              <Zap className="w-4 h-4 text-brand-red fill-brand-red" />
              <Zap className="w-4 h-4 text-brand-red fill-brand-red" />
            </div>
            <span className="text-brand-red text-xs sm:text-sm font-black uppercase tracking-[0.25em]">Skip The Waiting Line</span>
            <div className="flex items-center gap-1">
              <Zap className="w-4 h-4 text-brand-red fill-brand-red" />
              <Zap className="w-4 h-4 text-brand-red fill-brand-red" />
            </div>
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white uppercase tracking-tight mb-4">
            Get Priority <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-red via-red-400 to-brand-red">Service</span>
          </h2>
          <p className="text-slate-400 text-base sm:text-lg max-w-xl mx-auto font-medium leading-relaxed">
            Tap any service to connect instantly on WhatsApp
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 relative z-10 mb-10">
          {quickServices.map((service, idx) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className={`group relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 hover:border-brand-red/60 rounded-3xl p-5 flex flex-col items-center text-center transition-all duration-500 hover:transform hover:scale-105 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(238,63,44,0.4)] card-pop-in card-pop-in-delay-${idx + 1} overflow-hidden`}
            >
              {/* Hover gradient overlay */}
              <div className="absolute inset-0 bg-gradient-to-b from-brand-red/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              
              {/* Glow effect */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-20 h-20 bg-brand-red/30 blur-[40px] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

              <div className="relative z-10 w-14 h-14 rounded-2xl bg-gradient-to-br from-brand-red to-red-600 flex items-center justify-center text-white mb-4 shadow-[0_10px_30px_rgba(238,63,44,0.4)] group-hover:shadow-[0_15px_40px_rgba(238,63,44,0.6)] group-hover:scale-110 transition-all duration-500">
                {service.icon}
              </div>
              
              <h3 className="relative z-10 text-white font-black text-sm uppercase tracking-wide mb-1 group-hover:text-brand-red transition-colors duration-300">
                {service.title}
              </h3>
              <p className="relative z-10 text-slate-400 text-xs font-medium mb-3 group-hover:text-slate-300 transition-colors duration-300">
                {service.subtitle}
              </p>

              {/* CTA Button inside card */}
              <span className="relative z-10 inline-flex items-center gap-1 px-4 py-2 bg-brand-red/20 hover:bg-brand-red text-brand-red hover:text-white rounded-full text-[10px] font-black uppercase tracking-wider transition-all duration-300 group/btn">
                {service.cta}
        ...
        {/* Premium Website Entry Button */}
        <div className="text-center relative z-10">
          <button
            onClick={onClose}
            className="group relative inline-flex items-center gap-4 px-10 py-5 bg-gradient-to-r from-slate-800 to-slate-900 hover:from-slate-700 hover:to-slate-800 rounded-full border border-slate-600 hover:border-slate-500 shadow-[0_10px_40px_rgba(0,0,0,0.5)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.6)] transition-all duration-500 overflow-hidden"
          >
            {/* Animated shimmer */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
            
            <span className="text-slate-300 group-hover:text-white font-bold uppercase tracking-[0.2em] text-sm transition-colors duration-300 relative z-10">
              Continue to Website
            </span>
            <div className="w-10 h-10 rounded-full bg-slate-700 group-hover:bg-brand-red flex items-center justify-center transition-all duration-300 relative z-10">
          ...
          <p className="text-slate-500 text-xs mt-4 font-medium">
            Browse our full range of premium tyres & services
          </p>
        </div>
      </div>
    </div>
...
const GallerySlideshow = () => {
  ...
  const galleryImages = [
    { src: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/Card%201.png', title: 'Tyre Fitting Service' },
    { src: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/Card%202.png', title: 'Wheel Alignment' },
    { src: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/Card%203.png', title: 'Nitrogen Filling' },
    { src: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/Card%204.png', title: 'Puncture Repair' },
    { src: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/CARD%205.png', title: 'Wheel Balancing' },
    { src: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/Tyremall.png', title: 'Tyremall Workshop' },
    { src: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/tyrewall.jpeg', title: 'Premium Tyre Collection' },
    { src: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/Creative.jpeg', title: 'Expert Service Team' }
  ];
  ...
  return (
    <div className="py-16 bg-slate-950 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className="text-3xl sm:text-4xl font-black text-white uppercase tracking-tight mb-3">
            Our <span className="text-brand-red">Workshop</span> Gallery
          </h2>
          <p className="text-slate-400 text-sm max-w-xl mx-auto">
            Explore our state-of-the-art facility and premium tyre services
          </p>
        </div>

        {/* Main Slideshow */}
        <div
          className="relative rounded-[32px] overflow-hidden shadow-[0_30px_80px_rgba(238,63,44,0.2)] border border-slate-800"
        ...
        >
          ...
          <div className="relative aspect-[16/9] md:aspect-[21/9] bg-slate-900">
            ...
            <button
              onClick={goToPrev}
              className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white hover:bg-brand-red hover:border-brand-red transition-all duration-300 group z-10"
            >
              <ArrowRight className="w-5 h-5 rotate-180 group-hover:-translate-x-0.5 transition-transform" />
            </button>
            <button
              onClick={goToNext}
              className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white hover:bg-brand-red hover:border-brand-red transition-all duration-300 group z-10"
            >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10 z-10">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-white font-black text-xl md:text-2xl uppercase tracking-wide">
            ...
            {/* Slide Counter */}
            <div className="absolute top-6 right-6 bg-slate-950/60 backdrop-blur-md px-4 py-2 rounded-full border border-slate-700">
              <span className="text-brand-red font-black text-sm">{currentIndex + 1}</span>
              <span className="text-slate-400 text-sm mx-1">/</span>
              <span className="text-slate-400 text-sm">{galleryImages.length}</span>
            </div>
          </div>

          {/* Thumbnail Navigation */}
          <div className="bg-slate-900/50 backdrop-blur-sm p-4 border-t border-slate-800">
            <div className="flex justify-center gap-2 md:gap-3 overflow-x-auto pb-2">
              {galleryImages.map((img, idx) => (
                <button
                  key={idx}
                  onClick={() => goToSlide(idx)}
                  className={`relative flex-shrink-0 w-16 h-12 md:w-24 md:h-16 rounded-xl overflow-hidden transition-all duration-300 ${
                    idx === currentIndex
                      ? 'ring-2 ring-brand-red ring-offset-2 ring-offset-slate-900 scale-105'
          ...
          <div className="absolute bottom-0 left-0 right-0 h-1 bg-slate-800">
            <div
              className="h-full bg-brand-red transition-all duration-300 ease-linear"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div ref={ref} className={`text-center max-w-3xl mx-auto animate-on-scroll ${isVisible ? 'is-visible' : ''}`}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <a href="https://wa.me/7088110172" target="_blank" rel="noreferrer" className="flex items-center gap-2 clip-btn-outline px-8 py-4 font-bold uppercase tracking-widest text-sm w-full sm:w-auto justify-center group hover:bg-[#25D366] hover:text-white hover:border-[#25D366]">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" /></svg>
              WhatsApp Us
            </a>
          </div>
...
const BrandsShowcase = ({ onOpenModal }) => {
  ...
  return (
    <>
      <div id="brands" className="py-24 bg-white border-y border-slate-100 scroll-mt-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div ref={ref} className={`grid grid-cols-2 md:grid-cols-4 gap-6 mb-6 animate-on-scroll ${isVisible ? 'is-visible' : ''}`}>
            {mainBrandLogos.slice(0, 4).map((brand, idx) => (
              <div
                key={brand.name}
                onClick={() => handleCardClick(brand)}
                className={`relative overflow-hidden rounded-[28px] p-6 md:p-8 flex flex-col items-center justify-between group card-pop-in card-pop-in-delay-${idx + 1} cursor-pointer bg-white border border-slate-200 shadow-[0_18px_40px_rgba(15,23,42,0.08)] transition-all duration-500`}
              >
                <span className="sr-only">{brand.name}</span>
                <div className="absolute inset-px rounded-[26px] bg-white/80 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative h-24 md:h-28 w-full flex items-center justify-center">
                  <div className="absolute w-[160%] h-[160%] bg-[radial-gradient(circle_at_center,rgba(255,199,44,0.18),transparent_70%)] blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  <img
                    src={brand.url}
                    alt={`${brand.name} logo`}
                    className="relative z-10 h-full w-auto object-contain drop-shadow-[0_6px_18px_rgba(15,23,42,0.08)] group-hover:scale-110 transition-transform duration-500"
                  />
                </div>
                <p className="relative z-10 mt-6 text-[10px] md:text-xs font-semibold uppercase tracking-[0.35em] text-slate-700 text-center group-hover:text-slate-900">
                  {brand.tagline}
                </p>
              </div>
            ))}
          ...
          {/* Row 2: Last 3 brands */}
          <div className={`grid grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto animate-on-scroll ${isVisible ? 'is-visible' : ''}`}>
            {mainBrandLogos.slice(4).map((brand, idx) => (
              <div
                key={brand.name}
                onClick={() => handleCardClick(brand)}
                className={`relative overflow-hidden rounded-[28px] p-6 md:p-8 flex flex-col items-center justify-between group card-pop-in card-pop-in-delay-${idx + 1} cursor-pointer bg-white border border-slate-200 shadow-[0_18px_40px_rgba(15,23,42,0.08)] transition-all duration-500`}
          ...
          {/* Bottom Bar with CTA */}
          <div className="mt-12 bg-slate-900 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-white text-sm md:text-base font-medium">
              All brands available with <span className="text-brand-red font-black">manufacturer warranty</span>
            </p>
            <a
              href="https://wa.me/7088110172?text=Hi%20Tyremall,%20I%20would%20like%20to%20get%20a%20quote%20for%20tyres."
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 clip-btn bg-brand-red text-white px-8 py-4 font-black uppercase tracking-widest text-xs shadow-[0_10px_30px_rgba(238,63,44,0.4)] hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(238,63,44,0.6)] transition-all duration-300"
            >
              <Phone className="w-4 h-4" /> Get Best Quote
            </a>
          </div>
...
const ExpertServices = () => {
  ...
  // Auto-rotate every 1.5 seconds unless hovered
  useEffect(() => {
    if (isHovered) return;
    const interval = setInterval(() => {
  ...
  const services = [
    {
      ...
      image: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/Card%201.png'
    },
    {
      ...
      image: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/Card%202.png'
    },
    {
      ...
      image: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/Card%203.png'
    },
    {
      ...
      image: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/Card%204.png'
    },
    {
      ...
      image: 'https://file.garden/aaq7u9giWjY0-o-W/Tyre%20Mall/CARD%205.png'
    },
    {
      title: 'Tyre Rotation',
    ...
    <div id="services" className="py-24 bg-slate-50 border-y border-slate-200 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className={`flex flex-col lg:flex-row gap-6 lg:gap-10 animate-on-scroll ${isVisible ? 'is-visible' : ''}`}>
          ...
          {/* Left Side: Interactive Services List with Images */}
          <div
          ...
          >
            {services.map((svc, idx) => (
              <div
                ...
                className={`cursor-pointer rounded-[20px] overflow-hidden transition-all duration-400 border-2 ${activeIndex === idx
              ...
              >
                {/* Service Image - Prominently Displayed */}
                <div className="relative w-full h-32 overflow-hidden">
                  <img
                    src={svc.image}
                    alt={svc.title}
                    className={`w-full h-full object-cover transition-all duration-500 ${activeIndex === idx ? 'scale-110' : 'scale-100'}`}
                  />
                  <div className={`absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent transition-opacity duration-300 ${activeIndex === idx ? 'opacity-100' : 'opacity-70'}`}></div>
                  {/* Icon Badge */}
                  <div className={`absolute top-3 left-3 w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-400 ${activeIndex === idx
                    ? 'bg-brand-red text-white shadow-[0_4px_12px_rgba(238,63,44,0.4)]'
                ...
                <div className="p-4 flex items-center justify-between">
                  ...
                  <ArrowRight className={`w-5 h-5 flex-shrink-0 transition-all duration-400 ${activeIndex === idx ? 'opacity-100 text-brand-red translate-x-0' : 'opacity-0 -translate-x-4'
                    }`} />
                </div>
              </div>
            ))}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-12 z-10">
              <div className="animate-futuristic-pop" key={`content-${activeIndex}`}>
                ...
                <div className="flex items-center gap-4 pl-1">
                  <a
                    href={`https://wa.me/7088110172?text=Hi%20Tyremall,%20I%20would%20like%20to%20book%20a%20${encodeURIComponent(services[activeIndex].title)}%20service.`}
                    target="_blank"
                    rel="noreferrer"
    ...
    <div id="about" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center animate-on-scroll is-visible">
          <a href="https://wa.me/7088110172?text=Hi%20Tyremall,%20I%20would%20like%20to%20get%20a%20free%20quote%20for%20tyres." target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 clip-btn bg-brand-red text-white px-10 py-4 font-bold uppercase tracking-widest text-sm hover:bg-slate-900 transition-colors duration-300 shadow-lg shadow-red-500/20 pulse-animation">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div ref={ref} className={`animate-on-scroll ${isVisible ? 'is-visible' : ''}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <a href="https://wa.me/7088110172" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 clip-btn-outline px-8 py-4 font-bold uppercase tracking-widest text-xs hover:border-[#25D366] hover:text-[#25D366]">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" /></svg>
                WhatsApp Now
              </a>
            </div>
